...
#ifndef _ONEMKL_SPARSE_BLAS_BACKENDS_CUSPARSE_HANDLE_HPP_
#define _ONEMKL_SPARSE_BLAS_BACKENDS_CUSPARSE_HANDLE_HPP_
...
#endif // _ONEMKL_SPARSE_BLAS_BACKENDS_CUSPARSE_HANDLE_HPP_
